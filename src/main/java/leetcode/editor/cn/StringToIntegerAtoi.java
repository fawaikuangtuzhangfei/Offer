...
class Solution {
    public int myAtoi(String s) {
        ...
        while(index < length){
            ...
            // 如果大于范围 返回范围内的值
            if (result > Integer.MAX_VALUE / 10 || (result == Integer.MAX_VALUE / 10 && (aChar - '0') > Integer.MAX_VALUE % 10)) {
                return Integer.MAX_VALUE;
            }
            if (result < Integer.MIN_VALUE / 10 || (result == Integer.MIN_VALUE / 10 && (aChar - '0') > -(Integer.MIN_VALUE % 10))) {
                return Integer.MIN_VALUE;
            }
            result = result * 10 + flag * (aChar - '0') ;
            index++;
        }
